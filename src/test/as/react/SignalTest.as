...
public class SignalTest
{
    ...
    public function testSignalToSlot () :void {
        ...
        signal.emit(2);
        signal.emit(3);
        Assert.equals(new <Object>[1, 2, 3], slot.events);
    }
    ...
    public function testOneShotSlot () :void {
        ...
        signal.emit(2);
        signal.emit(3);
        Assert.equals(new <Object>[1], slot.events);
    }
    ...
    public function testSlotPriority () :void {
        ...
        signal.emit();
        Assert.equals(4, slot1.order);
        Assert.equals(3, slot2.order);
        Assert.equals(2, slot3.order);
        Assert.equals(1, slot4.order);
    }
    ...
    public function testAddDuringDispatch () :void {
        ...
        signal.emit(5);
        Assert.equals(0, toAdd.events.length);

        // now dispatch an event that should go to the added signal
        signal.emit(42);
        Assert.equals(new <Object>[42], toAdd.events);
    }
    ...
    public function testRemoveDuringDispatch () :void {
        ...
        signal.emit(5);
        Assert.equals(new <Object>[5], toRemove.events);
    ...
    public function testAddAndRemoveDuringDispatch () :void {
        ...
        Assert.equals(new <Object>[5, 42], toRemove.events);
        Assert.equals(0, toAdd.events.length);

        // finally emit one more and ensure that toAdd got it and toRemove didn't
        signal.emit(9);
        Assert.equals(new <Object>[9], toAdd.events);
        Assert.equals(new <Object>[5, 42], toRemove.events);
    }
